...
<HeadTitle>References</HeadTitle>

Below you'll find some words former colleagues have been kind enough to share.

These references are also available on my [LinkedIn profile](https://uk.linkedin.com/in/joseph-luck).
...
Joe is hands down one of the best engineers I've worked with - incredibly efficient and quick, but not sacrificing quality in the process. I've learned quite a bit from him.
Joe is a great leader and mentor and it's been (and thankfully still is!) a privilege and pleasure working with him.
